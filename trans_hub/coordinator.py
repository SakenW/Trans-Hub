...
class Coordinator:
    ...
    async def initialize(self) -> None:
        ...
        active_engine = self._get_or_create_engine_instance(self.config.active_engine.value)
    ...
    async def request(
        ...
        *,
        ...
        source_fields = {"text": normalize_plain_text_for_reuse(source_payload.get("text"))}
        ...
        for lang in target_langs:
            ...
            tm_hit = await self.handler.find_tm_entry(
                project_id, namespace, reuse_sha, final_source_lang, lang,
            ...
            if tm_hit:
                ...
                logger.info("TM 命中，直接创建待审阅修订", revision_id=rev_id, head_id=head_id)
            else:
    ...
    async def get_translation(
        ...
        *,
        ...
        content_id = await self.handler.get_content_id_by_uida(project_id, namespace, keys_sha)
