...
def upgrade() -> None:
    ...
    op.create_table('events',
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(['project_id', 'head_id'], ['th.trans_head.project_id', 'th.trans_head.id'], name=op.f('fk_events_head_id_trans_head'), ondelete='CASCADE'),
        schema='th'
    )
    ...
    op.create_table('comments',
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(['project_id', 'head_id'], ['th.trans_head.project_id', 'th.trans_head.id'], name=op.f('fk_comments_head_id_trans_head'), ondelete='CASCADE'),
        schema='th'
    )

    # === th.locales_fallbacks ===
    op.create_table('locales_fallbacks',
        sa.Column('project_id', sa.Text(), nullable=False),
    ...
    op.create_table('tm_links',
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
        sa.ForeignKeyConstraint(['project_id', 'translation_rev_id'], ['th.trans_rev.project_id', 'th.trans_rev.id'], name=op.f('fk_tm_links_rev_id_trans_rev'), ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['tm_id'], ['th.tm_units.id'], name=op.f('fk_tm_links_tm_id_tm_units'), ondelete='CASCADE'),
