        ...
        op.execute(
            ...
            BEGIN
              IF NOT EXISTS (
                ...
                ALTER TABLE th.events ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY;
              END IF;
              ...
              IF NOT EXISTS (
                ...
                ALTER TABLE th.comments ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY;
              END IF;
            END $$;
            """
        )
