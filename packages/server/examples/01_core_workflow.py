...
async def main() -> None:
    ...
    async with example_runner("th_example_01.db") as coordinator:
        ...
        logger.info(
            "✅ 模拟处理完成，新修订进入 'REVIEWED' 状态。", rev_id=reviewed_rev_id
        )
        ...
        assert (
            translation is not None and translation["text"] == "Willkommen in der App!"
        )
        ...
        logger.info(
            "🎉 成功添加并获取评论", author=comments[0].author, body=comments[0].body
        )
